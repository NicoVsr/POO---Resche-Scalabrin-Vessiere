				...
				<p>
					...
					if (empty($monsters)) {
						...
						foreach($monsters as $unmonster){
							echo '<a href="Personnage.php"'.$unmonster->id().'">'.htmlspecialchars($unmonster->nom()).'</a> (pv : '.$unmonster->pv().', expérience : '.$unmonster->experience().', niveau : '.$unmonster->niveau().', nombre des coups : '.$unmonster->nbCoups().'<br />';
